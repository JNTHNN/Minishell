...
#    Updated: 2024/04/15 19:24:23 by jgasparo         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
expander_utils expander_utils2 expander_utils3 history cd_utils cd_utils2 \
cd_utils3
PARSER_SRC		:= parser
EXPAND_SRC		:= expander
EXECUTOR_SRC	:= exec
...
SRC 			+= $(addprefix $(SRC_DIR)executor/, $(addsuffix .c, $(EXECUTOR_SRC)))
